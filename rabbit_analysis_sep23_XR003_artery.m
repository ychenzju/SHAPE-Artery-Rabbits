...
if ~exist(mat_file,'file') || strcmp(RELOAD_DATA,'yes')
    ...
    for caseid = STUDY_CASE_IDS
        ...
        heart_beat_freq_default = 230/60;
        
        %% define data files
        switch caseid
            %% L2-9 UP
            case 1
                filename = 'L2-9-LX-UP.csv'; hrmin = '17:19:36'; note = 'Long-Axis-UpStream';
            ...
            case 2
                filename = 'L2-9-LX-UP-HRES.csv'; hrmin = '17:20:25'; note = 'Long-Axis-UpStream';
                ...
                timelength_of_interest = timelength_of_interest_default;
            case 3
                filename = 'L2-9-SX-UP-01.csv'; hrmin = '17:25:44'; note = 'Short-Axis-UpStream#1';
                probe = 'L2-9'; imgmode = 'RES1'; cc = 0.024; mi = 0.08;
                ...
                timelength_of_interest = timelength_of_interest_default;
            case 4
                filename = 'L2-9-SX-UP-02.csv'; hrmin = '17:26:40'; note = 'Short-Axis-UpStream#2';
                probe = 'L2-9'; imgmode = 'RES1'; cc = 0.024; mi = 0.08;
                ...
                timelength_of_interest = timelength_of_interest_default;
            case 5
                filename = 'L2-9-SX-UP-03.csv'; hrmin = '17:27:32'; note = 'Short-Axis-UpStream#3';
                probe = 'L2-9'; imgmode = 'RES1'; cc = 0.024; mi = 0.08;
                ...
                timelength_of_interest = timelength_of_interest_default;
            case 6
                filename = 'L2-9-SX-UP-04.csv'; hrmin = '17:28:40'; note = 'Short-Axis-UpStream#4';
                probe = 'L2-9'; imgmode = 'RES1'; cc = 0.024; mi = 0.08;
                ...
                timelength_of_interest = timelength_of_interest_default;
            case 7
                filename = 'L2-9-SX-UP-05.csv'; hrmin = '17:29:30'; note = 'Short-Axis-UpStream#5';
                probe = 'L2-9'; imgmode = 'RES1'; cc = 0.024; mi = 0.08;
                ...
                %% L2-9 Down
            case 8
                filename = 'L2-9-LX-DOWN.csv'; hrmin = '17:23:12'; note = 'Long-Axis-DownStream';
                probe = 'L2-9'; imgmode = 'RES1'; cc = 0.024; mi = 0.08;
                trace_labels = {'Proximal-1(Most)','Proximal-2','Proximal-3','Proximal-4',...
                ...
                timelength_of_interest = timelength_of_interest_default;
            case 9
                filename = 'L2-9-LX-DOWN-HRES.csv'; hrmin = '17:23:56'; note = 'Long-Axis-DownStream';
                probe = 'L2-9'; imgmode = 'HRES'; cc = 0.024; mi = 0.08;
                trace_labels = {'Proximal-1(Most)','Proximal-2','Proximal-3','Proximal-4',...
                    'Distal-5','Distal-6','Distal-7','Distal-8'};
                visualize_trace_list = [1,2,3,4,5,6,7,8];
                ...
                timelength_of_interest = timelength_of_interest_default;
            case 10
                filename = 'L2-9-SX-DOWN-01.csv'; hrmin = '17:30:26'; note = 'Short-Axis-DownStream#1';
                probe = 'L2-9'; imgmode = 'RES1'; cc = 0.024; mi = 0.08;
                ...
                timelength_of_interest = timelength_of_interest_default;
            case 11
                filename = 'L2-9-SX-DOWN-02.csv'; hrmin = '17:31:37'; note = 'Short-Axis-DownStream#2';
                probe = 'L2-9'; imgmode = 'RES1'; cc = 0.024; mi = 0.08;
                ...
                timelength_of_interest = timelength_of_interest_default;
            case 12
                filename = 'L2-9-SX-DOWN-03.csv'; hrmin = '17:32:36'; note = 'Short-Axis-DownStream#3';
                probe = 'L2-9'; imgmode = 'RES1'; cc = 0.024; mi = 0.08;
                ...
                timelength_of_interest = timelength_of_interest_default;
            case 13
                filename = 'L2-9-SX-DOWN-04.csv'; hrmin = '17:33:58'; note = 'Short-Axis-DownStream#4';
                probe = 'L2-9'; imgmode = 'RES1'; cc = 0.024; mi = 0.08;
                ...
                timelength_of_interest = timelength_of_interest_default;
            case 14
                filename = 'L2-9-SX-DOWN-05.csv'; hrmin = '17:34:49'; note = 'Short-Axis-DownStream#5';
                probe = 'L2-9'; imgmode = 'RES1'; cc = 0.024; mi = 0.08;
                ...
                %% C1-6 UP
            case 15
                filename = 'C1-6-LX-UP.csv'; hrmin = '17:50:36'; note = 'Long-Axis-UpStream';
                probe = 'C1-6'; imgmode = 'SHAM'; cc = 0.024; mi = 0.30;
                trace_labels = {'Proximal-1(Most)','Proximal-2','Proximal-3','Proximal-4',...
                    'Distal-5','Distal-6','Distal-7','Distal-8(Most)'};
                visualize_trace_list = [1,2,3,4,5,6,7,8];
                start_time_of_interest = start_time_of_interest_default;
                timelength_of_interest = timelength_of_interest_default;
            case 16
                filename = 'C1-6-LX-UP-HRES.csv'; hrmin = '17:51:33'; note = 'Long-Axis-UpStream';
                probe = 'C1-6'; imgmode = 'HRES'; cc = 0.024; mi = 0.30;
                trace_labels = {'Proximal-1(most)','Proximal-2','Proximal-3','Proximal-4',...
                    'Distal-5','Distal-6','Distal-7','Distal-8(Most)'};
                visualize_trace_list = [1,2,3,4,5,6,7,8];
                start_time_of_interest = start_time_of_interest_default;
                timelength_of_interest = timelength_of_interest_default;
            case 17
                filename = 'C1-6-SX-UP-01.csv'; hrmin = '17:53:47'; note = 'Short-Axis-UpStream#1';
                probe = 'C1-6'; imgmode = 'SHAM'; cc = 0.024; mi = 0.30;
                trace_labels = {'SX-UP#1-1','SX-UP#1-2','SX-UP#1-3','SX-UP#1-4',...
                    'SX-UP#1-5','Unknown-6','Unknown-7','Unknown-8'};
                visualize_trace_list = [1,2,3,4,5];
                ...
                timelength_of_interest = timelength_of_interest_default;
            case 18
                filename = 'C1-6-SX-UP-02.csv'; hrmin = '17:54:43'; note = 'Short-Axis-UpStream#2';
                probe = 'C1-6'; imgmode = 'SHAM'; cc = 0.024; mi = 0.30;
                trace_labels = {'SX-UP#2-1','SX-UP#2-2','SX-UP#2-3','SX-UP#2-4',...
                    'SX-UP#2-5','Unknown-6','Unknown-7','Unknown-8'};
                visualize_trace_list = [1,2,3,4,5];
                ...
                timelength_of_interest = timelength_of_interest_default;
            case 19
                filename = 'C1-6-SX-UP-03.csv'; hrmin = '17:55:36'; note = 'Short-Axis-UpStream#3';
                probe = 'C1-6'; imgmode = 'SHAM'; cc = 0.024; mi = 0.30;
                trace_labels = {'SX-UP#3-1','SX-UP#3-2','SX-UP#3-3','SX-UP#3-4',...
                    'SX-UP#3-5','Unknown-6','Unknown-7','Unknown-8'};
                visualize_trace_list = [1,2,3,4,5];
                ...
                timelength_of_interest = timelength_of_interest_default;
            case 20
                filename = 'C1-6-SX-UP-04.csv'; hrmin = '17:56:48'; note = 'Short-Axis-UpStream#4';
                probe = 'C1-6'; imgmode = 'SHAM'; cc = 0.024; mi = 0.30;
                trace_labels = {'SX-UP#4-1','SX-UP#4-2','SX-UP#4-3','SX-UP#4-4',...
                    'SX-UP#4-5','Unknown-6','Unknown-7','Unknown-8'};
                visualize_trace_list = [1,2,3,4,5];
                ...
                timelength_of_interest = timelength_of_interest_default;
            case 21
                filename = 'C1-6-SX-UP-05.csv'; hrmin = '17:57:41'; note = 'Short-Axis-UpStream#5';
                probe = 'C1-6'; imgmode = 'SHAM'; cc = 0.024; mi = 0.30;
                trace_labels = {'SX-UP#5-1','SX-UP#5-2','SX-UP#5-3','SX-UP#5-4',...
                    'SX-UP#5-5','Unknown-6','Unknown-7','Unknown-8'};
                visualize_trace_list = [1,2,3,4,5];
                ...
                %% C1-6 DOWN
            case 22
                filename = 'C1-6-LX-DOWN.csv'; hrmin = '17:49:25'; note = 'Long-Axis-DownStream';
                probe = 'C1-6'; imgmode = 'RES1'; cc = 0.024; mi = 0.30;
                trace_labels = {'Proximal-1(Most)','Proximal-2','Proximal-3','Proximal-4',...
                    'Distal-5','Distal-6','Distal-7','Distal-8(Most)'};
                visualize_trace_list = [1,2,3,4,5,6,7,8];
                start_time_of_interest = start_time_of_interest_default;
                timelength_of_interest = timelength_of_interest_default;
            case 23
                filename = 'C1-6-LX-DOWN-HRES.csv'; hrmin = '17:48:36'; note = 'Long-Axis-DownStream';
                probe = 'C1-6'; imgmode = 'HRES'; cc = 0.024; mi = 0.30;
                trace_labels = {'Proximal-1(Most)','Proximal-2','Proximal-3','Proximal-4',...
                    'Distal-5','Distal-6','Distal-7','Distal-8(Most)'};
                visualize_trace_list = [1,2,3,4,5,6,7,8];
                ...
                timelength_of_interest = timelength_of_interest_default;
            case 24
                filename = 'C1-6-SX-DOWN-01.csv'; hrmin = '17:59:25'; note = 'Short-Axis-DownStream#1';
                probe = 'C1-6'; imgmode = 'SHAM'; cc = 0.024; mi = 0.30;
                trace_labels = {'SX-DN#1-1','SX-DN#1-2','SX-DN#1-3','SX-DN#1-4',...
                    'SX-DN#1-5','Unknown-6','Unknown-7','Unknown-8'};
                visualize_trace_list = [1,2,3,4,5];
                ...
                timelength_of_interest = timelength_of_interest_default;
            case 25
                filename = 'C1-6-SX-DOWN-02.csv'; hrmin = '18:00:46'; note = 'Short-Axis-DownStream#2';
                probe = 'C1-6'; imgmode = 'SHAM'; cc = 0.024; mi = 0.30;
                trace_labels = {'SX-DN#2-1','SX-DN#2-2','SX-DN#2-3','SX-DN#2-4',...
                    'SX-DN#2-5','Unknown-6','Unknown-7','Unknown-8'};
                visualize_trace_list = [1,2,3,4,5];
                ...
                timelength_of_interest = timelength_of_interest_default;
            case 26
                filename = 'C1-6-SX-DOWN-03.csv'; hrmin = '18:01:43'; note = 'Short-Axis-DownStream#3';
                probe = 'C1-6'; imgmode = 'SHAM'; cc = 0.024; mi = 0.30;
                trace_labels = {'SX-DN#3-1','SX-DN#3-2','SX-DN#3-3','SX-DN#3-4',...
                    'SX-DN#3-5','Unknown-6','Unknown-7','Unknown-8'};
                visualize_trace_list = [1,2,3,4,5];
                ...
                timelength_of_interest = timelength_of_interest_default;
            case 27
                filename = 'C1-6-SX-DOWN-04.csv'; hrmin = '18:03:15'; note = 'Short-Axis-DownStream#4';
                probe = 'C1-6'; imgmode = 'SHAM'; cc = 0.024; mi = 0.30;
                trace_labels = {'SX-DN#4-1','SX-DN#4-2','SX-DN#4-3','SX-DN#4-4',...
                    'SX-DN#4-5','Unknown-6','Unknown-7','Unknown-8'};
                visualize_trace_list = [1,2,3,4,5];
                ...
                timelength_of_interest = timelength_of_interest_default;
            case 28
                filename = 'C1-6-SX-DOWN-05.csv'; hrmin = '18:04:39'; note = 'Short-Axis-DownStream#5';
                probe = 'C1-6'; imgmode = 'SHAM'; cc = 0.024; mi = 0.30;
                trace_labels = {'SX-DN#5-1','SX-DN#5-2','SX-DN#5-3','SX-DN#5-4',...
                    'SX-DN#5-5','Unknown-6','Unknown-7','Unknown-8'};
                visualize_trace_list = [1,2,3,4,5];
