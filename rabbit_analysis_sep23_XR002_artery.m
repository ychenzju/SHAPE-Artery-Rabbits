...
if ~exist(mat_file,'file') || strcmp(RELOAD_DATA,'yes')
    ...
    for caseid = STUDY_CASE_IDS
        ...
        timelength_of_interest_default = 40;
        heart_beat_freq_default = 180/60;
        
        %% define data files
        switch caseid
            %% L2-9 UP
            case 1
                filename = 'L2-9-LX-UP.csv'; hrmin = '15:01:07'; note = 'Long-Axis-UpStream';
                probe = 'L2-9'; imgmode = 'RES1'; cc = 0.024; mi = 0.08;
            ...
            case 2
                filename = 'L2-9-LX-UP-HRES.csv'; hrmin = '15:01:52'; note = 'Long-Axis-UpStream';
                probe = 'L2-9'; imgmode = 'HRES'; cc = 0.024; mi = 0.08;
                ...
                timelength_of_interest = timelength_of_interest_default;
            case 3
                filename = 'L2-9-SX-UP-01.csv'; hrmin = '15:04:51'; note = 'Short-Axis-UpStream#1';
                probe = 'L2-9'; imgmode = 'RES1'; cc = 0.024; mi = 0.08;
                ...
                timelength_of_interest = timelength_of_interest_default;
            case 4
                filename = 'L2-9-SX-UP-02.csv'; hrmin = '15:06:08'; note = 'Short-Axis-UpStream#2';
                probe = 'L2-9'; imgmode = 'RES1'; cc = 0.024; mi = 0.08;
                ...
                timelength_of_interest = timelength_of_interest_default;
            case 5
                filename = 'L2-9-SX-UP-03.csv'; hrmin = '15:07:18'; note = 'Short-Axis-UpStream#3';
                probe = 'L2-9'; imgmode = 'RES1'; cc = 0.024; mi = 0.08;
                ...
                timelength_of_interest = timelength_of_interest_default;
            case 6
                filename = 'L2-9-SX-UP-04.csv'; hrmin = '15:08:15'; note = 'Short-Axis-UpStream#4';
                probe = 'L2-9'; imgmode = 'RES1'; cc = 0.024; mi = 0.08;
                ...
                timelength_of_interest = timelength_of_interest_default;
            case 7
                filename = 'L2-9-SX-UP-05.csv'; hrmin = '15:09:06'; note = 'Short-Axis-UpStream#5';
                probe = 'L2-9'; imgmode = 'RES1'; cc = 0.024; mi = 0.08;
                ...
                %% L2-9 Down
            case 8
                filename = 'L2-9-LX-DOWN.csv'; hrmin = '15:17:15'; note = 'Long-Axis-DownStream';
                probe = 'L2-9'; imgmode = 'RES1'; cc = 0.024; mi = 0.08;
                trace_labels = {'Proximal-1(Most)','Proximal-2','Proximal-3','Proximal-4',...
                    'Distal-5','Distal-6','Distal-7','Distal-8'};
                visualize_trace_list = [1,3,4,5];
                start_time_of_interest = start_time_of_interest_default;
                timelength_of_interest = timelength_of_interest_default;
            case 9
                filename = 'L2-9-LX-DOWN-HRES.csv'; hrmin = '15:18:35'; note = 'Long-Axis-DownStream';
                probe = 'L2-9'; imgmode = 'HRES'; cc = 0.024; mi = 0.08;
                trace_labels = {'Proximal-1(Most)','Proximal-2','Proximal-3','Proximal-4',...
                    'Distal-5','Distal-6','Distal-7','Distal-8'};
                visualize_trace_list = [1,2,3,4,5,6,7,8];
                ...
                timelength_of_interest = timelength_of_interest_default;
            case 10
                filename = 'L2-9-SX-DOWN-01.csv'; hrmin = '15:10:25'; note = 'Short-Axis-DownStream#1';
                probe = 'L2-9'; imgmode = 'RES1'; cc = 0.024; mi = 0.08;
                ...
                timelength_of_interest = timelength_of_interest_default;
            case 11
                filename = 'L2-9-SX-DOWN-02.csv'; hrmin = '15:11:21'; note = 'Short-Axis-DownStream#2';
                probe = 'L2-9'; imgmode = 'RES1'; cc = 0.024; mi = 0.08;
                ...
                timelength_of_interest = timelength_of_interest_default;
            case 12
                filename = 'L2-9-SX-DOWN-03.csv'; hrmin = '15:12:14'; note = 'Short-Axis-DownStream#3';
                probe = 'L2-9'; imgmode = 'RES1'; cc = 0.024; mi = 0.08;
                ...
                timelength_of_interest = timelength_of_interest_default;
            case 13
                filename = 'L2-9-SX-DOWN-04.csv'; hrmin = '15:13:11'; note = 'Short-Axis-DownStream#4';
                probe = 'L2-9'; imgmode = 'RES1'; cc = 0.024; mi = 0.08;
                ...
                timelength_of_interest = timelength_of_interest_default;
            case 14
                filename = 'L2-9-SX-DOWN-05.csv'; hrmin = '15:14:23'; note = 'Short-Axis-DownStream#5';
                probe = 'L2-9'; imgmode = 'RES1'; cc = 0.024; mi = 0.08;
                ...
                %% C1-6 UP
            case 15
                filename = 'C1-6-LX-UP.csv'; hrmin = '15:24:25'; note = 'Long-Axis-UpStream';
                probe = 'C1-6'; imgmode = 'SHAM'; cc = 0.024; mi = 0.18;
                trace_labels = {'Proximal-1(Most)','Proximal-2','Proximal-3','Proximal-4',...
                    'Distal-5','Distal-6','Distal-7','Distal-8(Most)'};
                visualize_trace_list = [1,2,3,4,5,6,7,8];
                start_time_of_interest = start_time_of_interest_default;
                timelength_of_interest = timelength_of_interest_default;
            case 16
                filename = 'C1-6-LX-UP-HRES.csv'; hrmin = '15:25:13'; note = 'Long-Axis-UpStream';
                probe = 'C1-6'; imgmode = 'HRES'; cc = 0.024; mi = 0.18;
                trace_labels = {'Proximal-1(most)','Proximal-2','Proximal-3','Proximal-4',...
                    'Distal-5','Distal-6','Distal-7','Distal-8(Most)'};
                visualize_trace_list = [1,2,3,4,5,6,7,8];
                start_time_of_interest = start_time_of_interest_default;
                timelength_of_interest = timelength_of_interest_default;
            case 17
                filename = 'C1-6-SX-UP-01.csv'; hrmin = '15:29:41'; note = 'Short-Axis-UpStream#1';
                probe = 'C1-6'; imgmode = 'SHAM'; cc = 0.024; mi = 0.18;
                trace_labels = {'SX-UP#1-1','SX-UP#1-2','SX-UP#1-3','SX-UP#1-4',...
                    'SX-UP#1-5','Unknown-6','Unknown-7','Unknown-8'};
                visualize_trace_list = [1,2,3,4,5];
                ...
                timelength_of_interest = timelength_of_interest_default;
            case 18
                filename = 'C1-6-SX-UP-02.csv'; hrmin = '15:30:45'; note = 'Short-Axis-UpStream#2';
                probe = 'C1-6'; imgmode = 'SHAM'; cc = 0.024; mi = 0.18;
                trace_labels = {'SX-UP#2-1','SX-UP#2-2','SX-UP#2-3','SX-UP#2-4',...
                    'SX-UP#2-5','Unknown-6','Unknown-7','Unknown-8'};
                visualize_trace_list = [1,2,3,4,5];
                ...
                timelength_of_interest = timelength_of_interest_default;
            case 19
                filename = 'C1-6-SX-UP-03.csv'; hrmin = '15:31:53'; note = 'Short-Axis-UpStream#3';
                probe = 'C1-6'; imgmode = 'SHAM'; cc = 0.024; mi = 0.18;
                trace_labels = {'SX-UP#3-1','SX-UP#3-2','SX-UP#3-3','SX-UP#3-4',...
                    'SX-UP#3-5','Unknown-6','Unknown-7','Unknown-8'};
                visualize_trace_list = [1,2,3,4,5];
                ...
                timelength_of_interest = timelength_of_interest_default;
            case 20
                filename = 'C1-6-SX-UP-04.csv'; hrmin = '15:32:56'; note = 'Short-Axis-UpStream#4';
                probe = 'C1-6'; imgmode = 'SHAM'; cc = 0.024; mi = 0.18;
                trace_labels = {'SX-UP#4-1','SX-UP#4-2','SX-UP#4-3','SX-UP#4-4',...
                    'SX-UP#4-5','Unknown-6','Unknown-7','Unknown-8'};
                visualize_trace_list = [1,2,3,4,5];
                ...
                timelength_of_interest = timelength_of_interest_default;
            case 21
                filename = 'C1-6-SX-UP-05.csv'; hrmin = '15:33:50'; note = 'Short-Axis-UpStream#5';
                probe = 'C1-6'; imgmode = 'SHAM'; cc = 0.024; mi = 0.18;
                trace_labels = {'SX-UP#5-1','SX-UP#5-2','SX-UP#5-3','SX-UP#5-4',...
                    'SX-UP#5-5','Unknown-6','Unknown-7','Unknown-8'};
                visualize_trace_list = [1,2,3,4,5];
                ...
                %% C1-6 DOWN
            case 22
                filename = 'C1-6-LX-DOWN.csv'; hrmin = '15:26:39'; note = 'Long-Axis-DownStream';
                probe = 'C1-6'; imgmode = 'RES1'; cc = 0.024; mi = 0.18;
                trace_labels = {'Proximal-1(Most)','Proximal-2','Proximal-3','Proximal-4',...
                    'Distal-5','Distal-6','Distal-7','Distal-8(Most)'};
                visualize_trace_list = [1,2,3,4,5,6,7,8];
                start_time_of_interest = start_time_of_interest_default;
                timelength_of_interest = timelength_of_interest_default;
            case 23
                filename = 'C1-6-LX-DOWN-HRES.csv'; hrmin = '15:27:35'; note = 'Long-Axis-DownStream';
                probe = 'C1-6'; imgmode = 'HRES'; cc = 0.024; mi = 0.18;
                trace_labels = {'Proximal-1(Most)','Proximal-2','Proximal-3','Proximal-4',...
                    'Distal-5','Distal-6','Distal-7','Distal-8(Most)'};
                visualize_trace_list = [1,2,3,4,5,6,7,8];
                ...
                timelength_of_interest = timelength_of_interest_default;
            case 24
                filename = 'C1-6-SX-DOWN-01.csv'; hrmin = '15:35:31'; note = 'Short-Axis-DownStream#1';
                probe = 'C1-6'; imgmode = 'SHAM'; cc = 0.024; mi = 0.18;
                trace_labels = {'SX-DN#1-1','SX-DN#1-2','SX-DN#1-3','SX-DN#1-4',...
                    'SX-DN#1-5','Unknown-6','Unknown-7','Unknown-8'};
                visualize_trace_list = [1,2,3,4,5];
                ...
                timelength_of_interest = timelength_of_interest_default;
            case 25
                filename = 'C1-6-SX-DOWN-02.csv'; hrmin = '15:36:27'; note = 'Short-Axis-DownStream#2';
                probe = 'C1-6'; imgmode = 'SHAM'; cc = 0.024; mi = 0.18;
                trace_labels = {'SX-DN#2-1','SX-DN#2-2','SX-DN#2-3','SX-DN#2-4',...
                    'SX-DN#2-5','Unknown-6','Unknown-7','Unknown-8'};
                visualize_trace_list = [1,2,3,4,5];
                ...
                timelength_of_interest = timelength_of_interest_default;
            case 26
                filename = 'C1-6-SX-DOWN-03.csv'; hrmin = '15:37:21'; note = 'Short-Axis-DownStream#3';
                probe = 'C1-6'; imgmode = 'SHAM'; cc = 0.024; mi = 0.18;
                trace_labels = {'SX-DN#3-1','SX-DN#3-2','SX-DN#3-3','SX-DN#3-4',...
                    'SX-DN#3-5','Unknown-6','Unknown-7','Unknown-8'};
                visualize_trace_list = [1,2,3,4,5];
                ...
                timelength_of_interest = timelength_of_interest_default;
            case 27
                filename = 'C1-6-SX-DOWN-04.csv'; hrmin = '15:38:13'; note = 'Short-Axis-DownStream#4';
                probe = 'C1-6'; imgmode = 'SHAM'; cc = 0.024; mi = 0.18;
                trace_labels = {'SX-DN#4-1','SX-DN#4-2','SX-DN#4-3','SX-DN#4-4',...
                    'SX-DN#4-5','Unknown-6','Unknown-7','Unknown-8'};
                visualize_trace_list = [1,2,3,4,5];
                ...
                timelength_of_interest = timelength_of_interest_default;
            case 28
                filename = 'C1-6-SX-DOWN-05.csv'; hrmin = '15:39:11'; note = 'Short-Axis-DownStream#5';
                probe = 'C1-6'; imgmode = 'SHAM'; cc = 0.024; mi = 0.18;
                trace_labels = {'SX-DN#5-1','SX-DN#5-2','SX-DN#5-3','SX-DN#5-4',...
                    'SX-DN#5-5','Unknown-6','Unknown-7','Unknown-8'};
                visualize_trace_list = [1,2,3,4,5];
...
for caseid = STUDY_CASE_IDS
    ...
    fig.Position=[196,782,1516,280];
    subplot(211);
    plot(sha_ts(:,c.time_index),sha_ts(:,c.trace_indices(1)),'-o','MarkerSize',3,'MarkerFaceColor','b');
    ylabel('Subharmonic(dB)');
    xlabel('Time(s)'); grid on;
    title(['The First Trace Signal ',trace_labels(1)]);
    ...
    subplot(212), hold on; plot(true_peak_ts(:,1),true_peak_ts(:,2),'r*','MarkerSize',4);
    %     xlim([start_time_of_interest,start_time_of_interest+5]);
...
%         combined_signalFiltered = extractSignal(resample_time, resample_signal, 0.2, 3);
        ...
        hold on;
        plot(time_outliers_removed, signal_outliers_removed,'co','MarkerSize',4);
